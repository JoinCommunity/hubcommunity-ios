...
final class EventsBusinessLogicTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testEvents = [
            ...
            Event(
                ...
                communities: [
                    Community(id: "3", title: "Web Developers", membersQuantity: 800),
                    Community(id: "4", title: "React Community", membersQuantity: 1200)
                ]
            )
        ]
    }
    ...
    func testGetUniqueTags() {
        ...
        let tagValues = uniqueTags.map(\.value)
    ...
    func testGetUniqueCommunities() {
        ...
        let communityTitles = uniqueCommunities.map(\.title)
